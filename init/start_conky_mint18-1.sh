...
case $RES_INFO in
    1366)
        # lenovo native laptop monitor
        conky --config=/home/blake/.conky/conkyrc_mint18-1_1366x768 2>/dev/null
        ;;
    1920)
        # home external monitor
        conky --config=/home/blake/.conky/conkyrc_mint18-1_1920x1080 2>/dev/null
	    ;;
    2560)
  	    # Lewisville office monitor setup.  Defaulted to 1366x768 for now
        conky --config=/home/blake/.conky/conkyrc_mint18-1_2560x1440 2>/dev/null
  	    ;;
    *)
